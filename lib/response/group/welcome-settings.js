...
import { setWelcomeLines, startWelcomeInput, finishWelcomeInput, cancelWelcomeInput, getWelcomeConfig, getWelcomeLines, formatWelcomeConfig, resetWelcomeLines } from '../../model/group/welcome.js';
...
const kindLabel = (kind) => kind === 'welcome' ? '欢迎' : '退出';
...
export { welcomeSettings as default };
