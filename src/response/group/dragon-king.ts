...
import type { OneBotGroupHonorInfo } from '../../adapter/onebot';
...
export default async () => {
  ...
  const honor = await client.getGroupHonorInfo({ group_id: groupId, type: 'talkative' }) as OneBotGroupHonorInfo | null;
