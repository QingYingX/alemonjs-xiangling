...
import { findRequest, removeRequest } from '../../model/admin/requests.js';
import { getRawArgs, getEventGroupId } from '../../model/group/admin.js';

var handleGroup = async () => {
