...
import { parseGroupOnlyArgs, formatMutedMembers } from '../../model/group/admin.js';
import { hasGroupAdminPermission, hasBotGroupAdminPermission } from '../../model/group/permissions.js';
...
var muteList = async () => {
    ...
    if (!members.length)
        warnUnsupportedShape('getGroupMemberList', raw);
