...
import { normalizeGroupList, warnUnsupportedShape } from '../../adapter/onebot.js';
import { formatGroupList } from '../../model/group/tools.js';
...
var groupList = async () => {
    ...
    if (!groups.length)
        warnUnsupportedShape('getGroupList', raw);
