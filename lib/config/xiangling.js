...
const getXianglingConfig = () => {
    ...
    return {
        ...
        group_manage: {
            auto_approve_group_invite: readBoolean(groupManage.auto_approve_group_invite, defaultConfig.group_manage.auto_approve_group_invite)
        }
    };
};
const getBotName = () => getXianglingConfig().bot_name;

export { getBotName, getXianglingConfig };
