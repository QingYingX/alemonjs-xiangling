...
import { parseMessageIdArg } from '../../model/group/admin.js';
import { getRecallPermissionConfig, hasRecallPermission } from '../../model/group/recall-permission.js';

var messageRecall = async () => {
...
export { messageRecall as default };
