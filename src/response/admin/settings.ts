...
import { buildSettingsImageData, formatSettingsText, getAdminSettings, setRenderScale, setStateAsDefault } from '../../model/admin/settings';
import SettingsImage from '../../image/component/settings';
