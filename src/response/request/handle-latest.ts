...
import { listRequests, removeRequest, type RequestRecord } from '../../model/admin/requests';
...
const describe = (record: RequestRecord): string => {
  if (record.kind === 'friend') return '好友申请 ' + record.userId;
